...
public class MyMeetingActivity extends FragmentActivity implements View.OnClickListener, MeetingVideoCallback.VideoEvent,
    ...
    MeetingShareHelper.MeetingShareUICallBack shareCallBack = new MeetingShareHelper.MeetingShareUICallBack() {
        ...
        public boolean requestStoragePermission() {
            if (Build.VERSION.SDK_INT >= 23 && checkSelfPermission(Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(MyMeetingActivity.this, new String[]{android.Manifest.permission.READ_EXTERNAL_STORAGE}, REQUEST_STORAGE_CODE);
                return false;
            }
            return true;
        }
    ...
    private void leave(boolean end) {
        ...
        finish();
        System.out.println("end meeting");
    ...
    public  void endMeeting(){
        ...
        Call<String> call = api.endMeeting();
...
//        inMeetingEventHandler.setRegisterWebinarInfo("test", time+"@example.com", false);
    ...
    private void unRegisterListener() {
        try {
            ...
            ZoomSDK.getInstance().getInMeetingService().removeListener(mInMeetingServiceListener);
        } catch (Exception e) {
        }
    }
        ...
        mInMeetingServiceListener = new SimpleInMeetingListener() {
            ...
            public void onRecordingStatus(RecordingStatus status) {
                if (status == RecordingStatus.Recording_Start) {
                    LegalNoticeDialogUtil.showChatLegalNoticeDialog(MyMeetingActivity.this);
                }
            }
