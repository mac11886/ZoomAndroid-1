...
public class MeetingSettingActivity extends FragmentActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_participant_id.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                options.customer_key = edit_participant_id.getText().toString();
            }
        });
        ...
        edit_participant_id.setText(options.customer_key);
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        switch (buttonView.getId()) {
            ...
            case R.id.no_chat_msg_toast:
                ZoomMeetingUISettingHelper.getMeetingOptions().no_chat_msg_toast = isChecked;
                break;
